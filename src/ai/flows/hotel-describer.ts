...
`;
    ...
    try {
      ...
      console.warn('Failed to generate hotel description with gemini-3.1-flash-lite-preview grounding, falling back to gemini-3.1-flash-lite with grounding', error);
      response = await ai.generate({
