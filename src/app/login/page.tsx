    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-50 p-4">
      <Card className="w-full max-w-md shadow-lg border-t-4 border-blue-600">
        <CardHeader className="text-center">
          <CardTitle className="text-3xl font-bold text-blue-900">TravelDiscovery</CardTitle>
        ...
        <CardContent className="flex flex-col items-center gap-6 py-6">
          ...
          <Button 
            ...
            className="w-full h-12 text-lg bg-white border border-slate-300 text-slate-700 hover:bg-slate-50 hover:text-slate-900 shadow-sm flex items-center justify-center gap-3"
          >
